...
internal object Utility {
    ...
    fun findMessageChannelDictionaryTarget(contracts: List<ClassInfo>, namespace: String? = null): ClassInfo {
        ...
        return ClassInfo(
            className = "AutoGeneratedMessageChannelDictionary",
    ...
    fun findMessageTranslatorResolverTarget(packageName: String): ClassInfo {
        return ClassInfo(
            packageName = packageName,
            className = "MessageTranslatorResolver"
        )
    }
